<script setup>
import { ChevronLeft, ChevronRight, DoorOpen } from 'lucide-vue-next'
      ...
      <div v-if="pagination" class="pagination-section">
        <div class="pagination-info">
          <span class="pagination-text">
            ...
            {{ Math.min(pagination.currentPage * pagination.itemsPerPage, pagination.totalClassrooms) }} of
            {{ pagination.totalClassrooms }} classrooms
          </span>
